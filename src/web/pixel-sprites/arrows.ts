...
import type { VoxelOverlay } from './voxel.js'
...
//
// Returns two layers: a dilated dark outline just under the white arrow, so
// the relief stays readable on light sprites like baba (same role as the
// texture overlay's shadow pass).
export const arrowOverlaysForDirection = (
  ...
  return [
    ...
    { frame, palette: ARROW_FILL_PALETTE, dx, dy, lift },
  ]
}
