export const BOARD3D_ANIMATION_CONFIG = {
  ...
  SPRITE_FRAME_MS: 500,
  IDLE_STRETCH_Y_AMP: 0.05,
  IDLE_STRETCH_X_AMP: 0.02,
  ...
  // sliding tile.
  FLOAT_ROLL_AMP: 0.07,
  MOVE_STRETCH_FACTOR: 0.2,
  MOVE_SQUASH_FACTOR: 0.16,
  LANDING_PULSE_HEIGHT: 0.055,
  SPAWN_VERTICAL_OFFSET: 0.2,
  DESPAWN_VERTICAL_OFFSET: 0.14,
  MOVE_ROLL_AMPLITUDE: 0.22,
} as const
